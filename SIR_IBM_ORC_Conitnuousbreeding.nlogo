...
@#$#@#$#@
<experiments>
  <experiment name="experiment_countingoffspring_BIRTHPULSE" repetitions="30" sequentialRunOrder="false" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="520"/>
    ...
    <enumeratedValueSet variable="frequency_transmission">
      <value value="true"/>
      <value value="false"/>
    </enumeratedValueSet>
  </experiment>

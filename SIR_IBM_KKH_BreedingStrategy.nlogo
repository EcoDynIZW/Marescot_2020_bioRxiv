...
to reproduce
    ...
    [
      set breedingadult count hyenas-here with [age >= age-repro]
...
@#$#@#$#@
<experiments>
  <experiment name="experimentsurvival" repetitions="30" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="520"/>
  ...
  <experiment name="experiment" repetitions="1" runMetricsEveryStep="true">
    ...
    <enumeratedValueSet variable="death-from-CDV">
      <value value="0"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="CLsurvival-probability">
      <value value="0.8"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="migration-probability">
      <value value="0.1"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="immunity-barrier">
      <value value="0"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="initial-rnot">
      <value value="3"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="average-clan">
      <value value="101"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="within-transmission">
      <value value="0.0246"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="fertility-probability">
      <value value="0.05"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="infection-length">
      <value value="10"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="SALsurvival-probability">
      <value value="0.8"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="neighborhood-variance">
      <value value="0"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="clan-number">
      <value value="37"/>
    ...
    <enumeratedValueSet variable="ALsurvival-probability">
      <value value="0.8"/>
    </enumeratedValueSet>
  </experiment>
...
setup</setup>
    ...
    <metric>infecub</metric>
    <metric>infecad</metric>
    <metric>suscub</metric>
    <metric>susad</metric>
    <metric>recub</metric>
    <metric>recad</metric>
    <metric>extinction</metric>
    <metric>within-transmission</metric>
    <metric>infecpatch</metric>
    <enumeratedValueSet variable="CLsurvival-probability">
      <value value="0.8"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="fertility-probability">
